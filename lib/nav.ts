...
export const navItems: NavItem[] = [
  ...
  { label: 'Colaboradores', href: '/app/collaborators', icon: UserCircle, roles: ['admin', 'receptionist'] },
  { label: 'Serviços', href: '/app/services', icon: Scissors, roles: ['admin', 'receptionist'] },
  { label: 'Produtos', href: '/app/products', icon: Package, roles: ['admin', 'receptionist'] },
  { label: 'Estoque', href: '/app/inventory', icon: Boxes, roles: ['admin', 'receptionist'] },
  { label: 'Vendas (PDV)', href: '/app/pos', icon: ShoppingCart, roles: ['admin', 'receptionist'] },
  { label: 'Caixa', href: '/app/cash-register', icon: Wallet, roles: ['admin'] },
  ...
  { label: 'Fidelidade', href: '/app/loyalty', icon: Gift, roles: ['admin', 'receptionist'] },
  { label: 'Relatórios', href: '/app/reports', icon: BarChart3, roles: ['admin'] },
  { label: 'Links de Agendamento', href: '/app/booking-links', icon: Link2, roles: ['admin', 'receptionist'] },
